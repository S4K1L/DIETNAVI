...
class _ExercisePageState extends State<ExercisePage> {
  ...
  final List<dynamic> exercises = [
    {
      ...
      'difficulty': 'beginner',
      'instructions': '1. Stand with feet shoulder-width apart. \n2. Lower body by bending knees, hinging at the hips. \n3. Push through to return to the starting position.',
    },
    {
      'name': 'Push-ups',
      'type': 'Strength',
      ...
      'instructions': '1. Start in a plank position. \n2. Lower body until chest nearly touches the ground. \n3. Push up to return to the starting position.',
    },
    {
      'name': 'Plank',
      'type': 'Strength',
      'muscle': 'Abdominals, Shoulders, Core',
      'equipment': 'Bodyweight',
      'difficulty': 'beginner',
      'instructions': '1. Get into a push-up position. \n2. Lower body by bending elbows to form a straight line from head to heels. \n3. Hold the position.',
    },
    {
  ...
  void filterExercises(double bmi) {
    try {
      if (bmi < 18.5) {
        // Underweight
        ...
        // Normal weight
        filteredExercises = exercises
            .where((exercise) => exercise['difficulty'] == 'intermediate')
            .toList();
      } else {
        // Overweight or Obese
        filteredExercises = exercises
      ...
      print("Error parsing weight or height: $e");
      // Handle the error here, for example, by setting default exercises
      filteredExercises = exercises
          .where((exercise) => exercise['difficulty'] == 'beginner')
          .toList();
    }
